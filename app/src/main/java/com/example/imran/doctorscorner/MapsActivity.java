...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
      ...
      Button btndoc = (Button) findViewById(R.id.btndoctors);
      ...
      Button btnambulance = (Button) findViewById(R.id.btnambulance);
        btnambulance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = getUrl(latitude, longitude, amb);
                Object[] DataTransfer = new Object[2];
                DataTransfer[0] = mMap;
                DataTransfer[1] = url;
                Log.d("onClick", url);
